...
const AboutUs = () => {
  return (
    <>
      <Seo
        title="About Us | Anchors Drilled & Held"
        description="Anchors Drilled & Held is a family-owned Wellington business with over 30 years of experience specialising in retaining walls, piling, anchors, and landscaping."
        url="https://anchorsdrilledheld.nz/about-us"
      ...
      <div className="body">
        <HeroCarousel
          ...
          alt="Anchors Drilled & Held team working on a retaining wall project"
          heading={
            <>
        ...
        <div className="split-container">
          ...
          <div className="split-container-p">
            ...
            <p>
              Anchors Drilled & Held is a proud family-owned and operated
              business located in the heart of Brooklyn, Wellington. For over 30
              years, we have been committed to serving Wellington and the
              surrounding regions with unwavering dedication. Throughout this
              time, we’ve built a reputation grounded in quality workmanship,
              dependable service, and honest, transparent relationships with our
              clients.
            </p>
            <p>
            ...
            <p>
              ...
              value the people who make Anchors Drilled & Held what it is — from
              our loyal, experienced workers who have grown with us over many
              years, to the clients who trust us to bring their visions to life.
              We pride ourselves on fostering a respectful and supportive
              workplace culture, emphasizing fair pricing, integrity in all we
              do, and consistently delivering on our promises — on time, every
              time.
            </p>
            <p>
